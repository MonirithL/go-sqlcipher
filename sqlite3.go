...
/*
#cgo CFLAGS: -I. -DSQLITE_ENABLE_RTREE -DSQLITE_ENABLE_FTS3 -DSQLITE_ENABLE_FTS3_PARENTHESIS -DSQLITE_ENABLE_FTS5 -DSQLITE_ENABLE_JSON1 -DSQLITE_THREADSAFE=1 -DSQLITE_ENABLE_COLUMN_METADATA -DSQLCIPHER_CRYPTO_LIBTOMCRYPT -I./libtomcrypt/src/headers
#cgo LDFLAGS: -L./libtomcrypt -ltomcrypt -L./libtommath -ltommath
...
func init() {
	fmt.Println("--- USING CUSTOM GO-SQLCIPHER BUILD ---")
